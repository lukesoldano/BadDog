...
public:
   ...
   std::optional<SpatialHashMapCell_t> add_entity(EntityId_t i_id, SDL_FPoint i_position);
   std::optional<SpatialHashMapCell_t> move_entity(EntityId_t i_id, SDL_FPoint i_position);
   std::optional<SpatialHashMapCell_t> remove_entity(EntityId_t i_id);

private:

   std::optional<SpatialHashMapCell_t> get_cell_for_position(SDL_FPoint i_position) const;
...
template <size_t X_CELLS, size_t Y_CELLS, size_t WIDTH, size_t HEIGHT>
std::optional<SpatialHashMapCell_t> SpatialHashMap<X_CELLS, Y_CELLS, WIDTH, HEIGHT>::get_cell_for_position(SDL_FPoint i_position) const
{
